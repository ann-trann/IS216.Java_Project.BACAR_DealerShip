...
public class AnnoucePanelLSC extends javax.swing.JPanel {

    private DialogPanel dialog;
    
    public AnnoucePanelLSC(DialogPanel dialog) {
        this.dialog = dialog;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Xe chưa được sửa, không tạo được hóa đơn");
