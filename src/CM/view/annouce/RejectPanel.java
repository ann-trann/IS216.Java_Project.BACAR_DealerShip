...
public class RejectPanel extends javax.swing.JPanel {

    private DialogPanel dialog;
    
    public RejectPanel(DialogPanel dialog) {
        this.dialog = dialog;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bạn không có quyền truy cập");
        ...
        jLabel2.setText("Chức vụ của bạn không có quyền truy cập vào đây");
        ...
        roundPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, roundPanel1Layout.createSequentialGroup()
                .addGap(174, 174, 174)
                .addComponent(cmdExit, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addGap(161, 161, 161))
        );
