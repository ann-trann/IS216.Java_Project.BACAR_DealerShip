...
public class HDForm extends javax.swing.JPanel {
    ...
    public HDForm() throws SQLException {
        initComponents();
        service = new Service();
    ...
    public void initHD() throws SQLException{
        ...
        for (ModelHoaDonSuaChua data : list){
            ...
            table.addRow(new Object[]{data.getMaHD(), tenKH, data.getNgay(), data.getThanhTien(), data.getMaNV()});
        }
    }
    ...
    private void txtSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSearchActionPerformed
        ...
        for (ModelHoaDonSuaChua data : list){
            try {
                ...
                table.addRow(new Object[]{data.getMaHD(), tenKH, data.getNgay(), data.getMaNV()});
