...
import CM.view.staff_component.MenuStaffKho;
...
public class Frame_StaffKho extends javax.swing.JFrame {
    ...
    public Frame_StaffKho() throws SQLException {
        this.model = model;
        initComponents();
        init();
    }
    
    public Frame_StaffKho(ModelNhanVien model) throws SQLException {
        this.model = model;
                ...
                switch(index){
                    case 0: {
                        try {
                            ...
                            Logger.getLogger(Frame_StaffKho.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
                    break;
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frame_StaffKho().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Frame_StaffKho.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public static void main(ModelNhanVien model) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frame_StaffKho(model).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Frame_StaffKho.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
